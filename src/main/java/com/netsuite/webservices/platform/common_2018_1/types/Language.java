 ...
 *     &lt;enumeration value="_afrikaans"/>
 *     &lt;enumeration value="_albanian"/>
 *     &lt;enumeration value="_arabic"/>
 *     &lt;enumeration value="_armenian"/>
 *     &lt;enumeration value="_bengali"/>
 *     &lt;enumeration value="_bosnian"/>
 ...
 *     &lt;enumeration value="_englishAu"/>
 *     &lt;enumeration value="_englishCa"/>
 *     &lt;enumeration value="_englishInternational"/>
 *     &lt;enumeration value="_englishUK"/>
 *     &lt;enumeration value="_englishUS"/>
 *     &lt;enumeration value="_estonian"/>
 *     &lt;enumeration value="_filipino"/>
 ...
 *     &lt;enumeration value="_gujarati"/>
 *     &lt;enumeration value="_haitian"/>
 *     &lt;enumeration value="_hebrew"/>
 *     &lt;enumeration value="_hindi"/>
 ...
 * 
 */
@XmlType(name = "Language", namespace = "urn:types.common_2018_1.platform.webservices.netsuite.com")
@XmlEnum
public enum Language {

    @XmlEnumValue("_afrikaans")
    AFRIKAANS("_afrikaans"),
    @XmlEnumValue("_albanian")
    ALBANIAN("_albanian"),
    @XmlEnumValue("_arabic")
    ARABIC("_arabic"),
    @XmlEnumValue("_armenian")
    ARMENIAN("_armenian"),
    @XmlEnumValue("_bengali")
    BENGALI("_bengali"),
    @XmlEnumValue("_bosnian")
    BOSNIAN("_bosnian"),
    ...
    @XmlEnumValue("_luxembourgish")
    LUXEMBOURGISH("_luxembourgish"),
    @XmlEnumValue("_malay")
    MALAY("_malay"),
    @XmlEnumValue("_marathi")
    MARATHI("_marathi"),
    @XmlEnumValue("_norwegian")
    NORWEGIAN("_norwegian"),
    @XmlEnumValue("_persianIran")
    ...
    @XmlEnumValue("_punjabi")
    PUNJABI("_punjabi"),
    @XmlEnumValue("_romanian")
    ROMANIAN("_romanian"),
    @XmlEnumValue("_russian")
    RUSSIAN("_russian"),
    @XmlEnumValue("_serbianCyrillic")
    SERBIAN_CYRILLIC("_serbianCyrillic"),
    @XmlEnumValue("_serbianLatin")
    ...
    @XmlEnumValue("_tamil")
    TAMIL("_tamil"),
    @XmlEnumValue("_telugu")
    TELUGU("_telugu"),
    @XmlEnumValue("_thai")
    THAI("_thai"),
    @XmlEnumValue("_turkish")
    TURKISH("_turkish"),
    @XmlEnumValue("_ukrainian")
