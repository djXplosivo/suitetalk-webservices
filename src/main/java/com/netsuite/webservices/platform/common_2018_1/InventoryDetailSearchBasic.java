 ...
 *         &lt;element name="inventoryNumber" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchMultiSelectField" minOccurs="0"/>
...
@XmlType(name = "InventoryDetailSearchBasic", propOrder = {
    "binNumber",
    "externalId",
    "externalIdString",
    "internalId",
