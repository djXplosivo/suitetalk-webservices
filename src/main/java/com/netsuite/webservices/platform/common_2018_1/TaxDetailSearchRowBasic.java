 ...
 *         &lt;element name="details" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="lineNumber" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnLongField" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="taxBasis" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnDoubleField" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="taxRate" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnDoubleField" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="tranId" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnLongField" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TaxDetailSearchRowBasic", propOrder = {
    "account",
    "details",
    "lineNumber",
    "taxAmount",
    ...
    extends SearchRowBasic
{
    ...
    protected List<SearchColumnStringField> details;
    ...
    protected List<SearchColumnLongField> tranId;
     ...
     * 
     */
    public List<SearchColumnStringField> getDetails() {
        if (details == null) {
            details = new ArrayList<SearchColumnStringField>();
        }
        return this.details;
    }
     ...
     * 
     */
    public List<SearchColumnLongField> getTranId() {
        if (tranId == null) {
            tranId = new ArrayList<SearchColumnLongField>();
        }
        return this.tranId;
    }
