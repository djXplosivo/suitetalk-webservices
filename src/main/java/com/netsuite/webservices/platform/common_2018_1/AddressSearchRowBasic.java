 ...
 *         &lt;element name="override" type="{urn:core_2018_1.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "AddressSearchRowBasic", propOrder = {
    "address",
    "address1",
    "address2",
    "address3",
