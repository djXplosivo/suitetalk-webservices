 ...
 * generated in the com.netsuite.webservices.lists.website_2018_1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SiteCategorySearch_QNAME = new QName("urn:website_2018_1.lists.webservices.netsuite.com", "siteCategorySearch");
    private final static QName _SiteCategory_QNAME = new QName("urn:website_2018_1.lists.webservices.netsuite.com", "SiteCategory");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.netsuite.webservices.lists.website_2018_1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:website_2018_1.lists.webservices.netsuite.com", name = "siteCategorySearch")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:website_2018_1.lists.webservices.netsuite.com", name = "SiteCategory")
